...
from cv_paper.A_alexnet.tools.my_dataset import CatDogDataset
...
if __name__ == "__main__":
    ...
    # config
    data_dir = os.path.join(BASE_DIR, "../../../../../Downloads/A_alexnet", "data", "train")
    path_state_dict = os.path.join(BASE_DIR, "../../../../../Downloads/A_alexnet", "data", "alexnet-owt-4df8aa71.pth")
    num_classes = 2
    ...
    if flag:
        ...
        optimizer = optim.SGD([
            {'params': base_params, 'lr': LR * 0.1},  # 0  LR for CNN
            {'params': alexnet_model.classifier.parameters(), 'lr': LR}], momentum=0.9)   # LR for FCN
